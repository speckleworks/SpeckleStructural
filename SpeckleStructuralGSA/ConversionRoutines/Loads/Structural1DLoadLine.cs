...
namespace SpeckleStructuralGSA
{
  ...
  public class GSAGridLineLoad : IGSASpeckleContainer
  {
    ...
    public void ParseGWACommand()
    {
      ...
      //(gridPlaneRefRet, gridSurfaceRec) = Initialiser.Interface.GetGridPlaneRef(Convert.ToInt32(pieces[counter++]));
    ...
    public void SetGWACommand()
    {
      ...
      for (int i = 0; i < load.Loading.Value.Count(); i++)
      {
        ...
        var index = Initialiser.Indexer.ResolveIndex(typeof(GSAGridLineLoad).GetGSAKeyword(), typeof(GSAGridLineLoad).Name);
  ...
  public static partial class Conversions
  {
    ...
    {
      new GSAGridLineLoad() { Value = load }.SetGWACommand();
